...
<dialog id="modal-terapeuta" class="modal-zen">
    ...
    <form id="form-terapeuta" autocomplete="off" method="POST" action="{{ route('admin.create-trabajador') }}" class="modal-form">
        @csrf
        ...
        <fieldset class="campo-formulario">
            ...
            <input type="number" id="telefono" name="telefono" required placeholder="Ej. 123-456-7890">
        </fieldset>
