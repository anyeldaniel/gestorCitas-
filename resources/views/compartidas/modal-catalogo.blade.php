        ...
        <form id="form-servicio"
                ...
                <section class="seccion-alineada-centro">
                    ...
                    <div class="contenedor-carga-foto">
                        ...
                        <section class="controles-archivo">
                            ...
                            <input type="file" id="servicio_foto" name="imagen" accept="image/*" style="display: none;">
            ...
            <fieldset class="campo-formulario-casilla">
                ...
                <p class="grupo-input-vertical">
                    ...
                    <input type="text" id="input_nombre" name="nombre_servicio" required minlength="3" maxlength="255" class="input-estandar-zen" placeholder="Ej. Masaje Descontracturante Profundo">
            ...
            <fieldset class="campo-formulario-casilla bg-slate-50/40">
                ...
                <section class="grid-tres-columnas-zen">
                    ...
                    <p class="grupo-input-vertical">
                        ...
                        <select id="input_tiempo" name="duracion_minutos" required class="select-estandar-zen">
                            <option value="45">30 min - 50 min</option>
                            <option value="75" selected>60 min - 90 min</option>
                            <option value="105">90 min - 120 min</option>
                            <option value="150">120 min - 180 min</option>
                        </select>
                    </p>
                </section>
            </fieldset>
