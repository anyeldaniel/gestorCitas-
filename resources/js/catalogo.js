...
document.addEventListener("DOMContentLoaded", () => {
    ...
    window.editarServicio = function (id) {
        ...
        if (tarjeta) {
            ...
            document.getElementById('form-servicio').action = `/admin/servicios/${id}/actualizar`;
            document.getElementById('input-metodo').value = 'PUT';
            document.getElementById('modal-servicio-titulo').innerText = "Editar Servicio";
...
window.verServicioDetalle = function (id) {
        ...
        if (tarjeta) {
            ...
            // Intentamos llenar los especialistas si el contenedor existe.
            if (contenedorTags) {
